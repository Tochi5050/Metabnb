...
const SearchScreen = () => {
  return (
    <div>
        <div className='mt-[6rem] ml-[2.9rem] text-[1.5rem] font-semibold not-italic xl:mt-[6rem] xl:ml-[5.3rem] xl:text-[3.4rem] xl:font-bold xl:not-italic'>
        ...
        <div className='font-redrose text-start whitespace-pre-line mt-[1rem] ml-[2.9rem] text-[1.1rem] font-medium not-italic xl:mt-[2rem] xl:ml-[5.3rem] xl:text-[1.4rem] xl:font-medium xl:not-italic'>
        ...
        <div className="flex flex-row xl:flex xl:flex-row">
            ...
            <div className=" font-redrose border-t-2 border-r-2 border-b-2 w-[8rem] h-11 rounded-md mt-8 mr-4 ml-[-8rem] px-[3rem] py-2 bg-[#A02279] border-[#A02279] text-white xl:ml-[5.3rem] xl:border-t-2 xl:border-r-2 xl:border-b-2 xl:w-[17rem] xl:h-11 xl:rounded-md xl:mt-8 xl:ml-[-10rem] xl:px-[7rem] xl:py-2 xl:bg-[#A02279] xl:border-[#A02279] xl:text-white">Search</div>
        </div>
        <div className='flex flex-col ml-[2.9rem] mt-[5rem] xl:flex xl:flex-col xl:ml-[48rem] xl:mt-[-19rem]'>
            <div>
