...
<div>
    ...
    <div>
        <div className='flex flex-row ml-[.8rem] md:ml-[3rem] py-[4rem] xl:flex xl:flex-row xl:ml-[5.3rem] xl:py-[4rem]'>
        ...
        <div className='flex flex-row ml-[.8rem] md:ml-[3rem] xl:flex xl:flex-row xl:ml-[5.3rem]'>
            ...
            <img src={TwitterLogo} alt="twitter logo" className='ml-[2rem] md:object-cover md:w-4 md:h-[.9rem] object-cover w-4 h-[.8rem]' />
    ...
    <div className='text-white ml-[10rem] md:ml-[16rem] mt-[-15rem] flex flex-row py-[4rem] leading-7 xl:text-white xl:ml-[20rem] xl:mt-[-15rem] xl:flex xl:flex-row xl:justify-around xl:py-[4rem] xl:leading-7'>
        <div >
