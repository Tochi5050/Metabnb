...
const MetaverseScreen = () => {
  return ( 
    ...
    <div>
        <div className='ml-[2.9rem] mt-[2rem] flex flex-col justify-between object-cover w-[21rem] h-[21rem] xl:ml-[5.3rem] xl:mt-[4rem] xl:flex xl:flex-row xl:justify-between xl:object-cover xl:w-[22.5rem] xl:h-[22.5rem]'>
        ...
        <div className='ml-[2.9rem] flex flex-col mt-[84rem] justify-between object-cover w-[21rem] h-[21rem] xl:ml-[5.3rem] xl:mt-[4rem] xl:flex xl:flex-row xl:justify-between xl:object-cover xl:w-[22.5rem] xl:h-[22.5rem]'>
